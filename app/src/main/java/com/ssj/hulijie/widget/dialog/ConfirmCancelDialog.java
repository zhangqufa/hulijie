...
public class ConfirmCancelDialog extends BaseDialog implements View.OnClickListener {
    ...
    // 退出dialog窗口
    public ConfirmCancelDialog(Context context, GoOther goOther, String content) {
        super(context, View.inflate(context, R.layout.dlg_confirm_cancle, null), new LayoutParams(DensityUtil.dip2px(context, 300), DensityUtil.dip2px(
                context, 121)));
