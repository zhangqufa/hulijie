...
public class LocationActivity extends AppCompatActivity implements OnScrollListener, OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
									int position, long id) {
				String currentCity = city_result.get(position).getName();
				Toast.makeText(getApplicationContext(),
						currentCity, Toast.LENGTH_SHORT)
						.show();
				confirm(currentCity);
			}
		});
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (viewType == 0) { // 定位
				...
				rencentCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
											int position, long id) {
						String currentCity = city_history.get(position);
						Toast.makeText(getApplicationContext(),
								currentCity, Toast.LENGTH_SHORT)
								.show();
						confirm(currentCity);
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						String currentCity = city_hot.get(position).getName();
						Toast.makeText(getApplicationContext(),
								currentCity, Toast.LENGTH_SHORT)
								.show();
						confirm(currentCity);
