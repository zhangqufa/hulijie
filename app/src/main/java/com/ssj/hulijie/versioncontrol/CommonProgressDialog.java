...
public class CommonProgressDialog extends AlertDialog implements View.OnClickListener {
    ...
    private ImageView progress_close;
    ...
    public CommonProgressDialog(Context context, GoOther goOther) {
        super(context);
        initFormats();
    ...
    public void setmHasStarted(boolean mHasStarted) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress_close = (ImageView) findViewById(R.id.progress_close);
        progress_close.setOnClickListener(this);
